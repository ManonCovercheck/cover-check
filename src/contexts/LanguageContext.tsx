...
const translations = {
  en: {
    ...
    'quiz.results.pricing': 'CoverCheck — 100% free for you.',
    ...
    'footer.pricing': 'CoverCheck — 100% free for you.',
  ...
  fr: {
    ...
    'quiz.results.pricing': 'CoverCheck — 100% gratuit pour vous.',
    ...
    'footer.pricing': 'CoverCheck — 100% gratuit pour vous.',
