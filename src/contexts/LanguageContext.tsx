...
const translations = {
  en: {
    ...
    'quiz.results.pricing': 'Free for everyone even Premium, if you invite 3 friends.',
    ...
    'footer.pricing': 'Free for everyone even Premium, if you invite 3 friends.',
  ...
  fr: {
    ...
    'quiz.results.pricing': 'Gratuit pour tous même Premium, si vous invitez 3 amis.',
    ...
    'footer.pricing': 'Gratuit pour tous même Premium, si vous invitez 3 amis.',
